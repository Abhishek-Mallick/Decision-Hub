...
const NO_ATTRIBUTE_HEADER = 'No Rules';
const NO_ATTRIBUTE_BODY = 'There is no rules available in the selected ruleset.'
const BUTTON_PROPS_ATTRIBUTE = {label: 'Create Rules'};
