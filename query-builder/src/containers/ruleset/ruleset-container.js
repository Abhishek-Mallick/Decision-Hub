...
const tabs = [{name: 'Rules'}, {name: 'Decisions'}, {name: 'Validate'}, {name: 'Generate'}];
class RulesetContainer extends Component {

    constructor(props) {
        super(props);
        this.state = {activeTab: 'Rules', generateFlag: false };
      ...
      return <div>
        <RuleErrorBoundary>
          ...
          <div className="tab-page-container">
              {this.state.activeTab === 'Rules' && <Attributes attributes={attributes} 
